...
serve(async (req) => {
  ...
  try {
    ...
    const allowed = ['events', 'news', 'deadlines', 'resource_links', 'event_sources', 'digest_send_log', 'startup_directory', 'event_feedback'];
    ...
    console.error('Error in admin-list-all:', error);
    return new Response(
