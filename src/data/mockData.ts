...
export const mockEvents: Event[] = [
  {
    id: '1',
    title: 'Founder Showcase: Startup Pitch Event',
    date: 'Jan 15',
    time: '9:00 AM PST',
    format: 'virtual',
    ...
    description: 'Silicon Valley\'s leading international pre-seed startup pitch event. Watch pitches, learn from VCs, and network globally.',
    url: 'https://www.foundershowcase.com/',
    featured: true,
  },
  {
    id: '2',
    title: 'FI: Legal Basics for Raising Capital',
    date: 'Jan 23',
    time: '1:00 PM EST',
    format: 'virtual',
    audience: ['Founders'],
    ...
    type: 'Workshop',
    organizer: 'Founder Institute',
    description: 'Learn legal fundamentals for fundraising including term sheets, SAFEs, and founder agreements.',
    url: 'https://fi.co/events',
  },
  {
    id: '3',
    title: 'Investor-Founder Mixer NYC',
    date: 'Jan 30',
    time: '6:00 PM EST',
    format: 'inperson',
    audience: ['Founders', 'Investors'],
    stage: ['Pre-seed', 'Seed'],
    type: 'Networking',
    organizer: 'Lynx Collective',
    description: 'Connect with BenchstrengthVC, Flybridge, Next Wave NYC and MGV investors in New York City.',
    url: 'https://lu.ma/Investor-Founder-Mixer-Jan2025',
  },
  {
    id: '4',
  ...
  {
    id: '7',
    title: 'FI: Diversifying Your Fundraising Mix',
    date: 'Feb 19',
    time: '12:00 PM EST',
    format: 'virtual',
    audience: ['Founders'],
    ...
    type: 'Workshop',
    organizer: 'Founder Institute',
    description: 'Learn the most effective ways to raise money beyond traditional VC, including grants, revenue-based financing, and more.',
    url: 'https://fi.co/events',
  },
  {
    id: '8',
    ...
    stage: ['Pre-seed', 'Seed'],
    type: 'Pitch Event',
    organizer: 'GGW Sharks',
    description: 'Pitch competition and networking event connecting startups with investors. Event #52 in the series.',
    url: 'https://www.eventbrite.com/e/ggw-sharks-startup-pitch-networking-investors-startups-52-tickets-1219923196119',
  },
  {
    id: '9',
  ...
  },
  {
    ...
    description: '400+ attendees. March Madness-style pitch competition for seed/Series A founders. Cash prize, panels, workshops, after-parties.',
    url: 'https://about.startupgrind.com/startup-mania-march-2025/',
    featured: true,
  },
  {
    id: '12',
    title: 'AsiaStartUpExpo Q1 2025: AI Showcase',
    date: 'Mar 19',
    time: '2:00 PM GMT+8',
    format: 'virtual',
    audience: ['Founders', 'Investors'],
    ...
    type: 'Expo',
    organizer: 'beSUCCESS',
    description: 'Virtual event connecting Asian AI startups with global investors. Exclusive 1-on-1 meetings with corporate buyers.',
    url: 'https://lu.ma/asiastartupexpo25q1',
  },
  {
    id: '13',
  ...
  },
  {
    ...
    description: 'Major tech conference featuring FoodTech, HealthTech, and AI tracks. Connects Israeli startups with global investors.',
    url: 'https://lu.ma/ISRTW25-FoodTech',
  },
];
